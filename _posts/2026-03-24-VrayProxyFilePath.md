---
layout: post
title: "VrayProxy FilePath 일괄 변경 스크립트"
date: 2026-03-24
---

Maya 씬 내 모든 VRay Proxy (.vrmesh) 경로를 새 폴더로 한 번에 변경해주는 Python 스크립트입니다.
...
- 씬 내 모든 VRayMesh 노드 자동 탐색
- 새 폴더 경로 입력 후 일괄 변경
- **미리보기** 기능으로 변경 전 확인 가능
...
3. GUI 창에서 **목록 새로고침** 으로 현재 VRayMesh 노드 확인
4. **찾아보기** 로 새 폴더 선택
5. **미리보기** 로 변경될 경로 확인 후 **경로 일괄 변경** 클릭
